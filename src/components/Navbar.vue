...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://flowbite.com/" class="flex items-center">
    <img class="w-10 h-10 rounded-full" src="../assets/nazril2.jpg.jpeg" alt="user photo">
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Portopolio Nazril</span>
  </a>
